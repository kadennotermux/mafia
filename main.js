...
console.log(color(`${spc4}< ================================================== >`, 'cyan'))
    ...
    console.log(color('[GingerBot]'), color('ɠıŋɠɛřცơŧ 𝗜𝘀 𝗢𝗻𝗹𝗶𝗻𝗲 ㋛︎', 'aqua'))
